...
export default class Newtonraphson extends Equations{
  ...
  //           this.state.Method.RootEquations.Newton.x,
  //           this.state.Error,
  //           this.state.Epsilon,
  //           this.state.Equation
  //       );
  ...
  //                 <TextField id="demo-helper-text-misaligned" label="X" type={"number"} defaultValue={this.state.Method.RootEquations.Newton.x} inputProps={{step: Math.pow(10,-6)}} onChange={this.xChange}/>
